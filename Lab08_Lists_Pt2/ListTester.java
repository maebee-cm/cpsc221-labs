	...
	*/
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testAddAfter" + contentsString.charAt(0), testAddAfter(scenario.build(), contents[0], ELEMENT_B, Result.NoException));
			...
			printTest(scenarioName + "_testAddAfterX", testAddAfter(scenario.build(), ELEMENT_C, ELEMENT_D, Result.NoSuchElement));
			...
			printTest(scenarioName + "_testRemoveAtIndexNeg1", testRemoveElement(scenario.build(), null, Result.NoSuchElement));
			printTest(scenarioName + "_testRemoveAtIndex0", testRemoveIndex(scenario.build(), 0, contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testRemoveAtIndex1", testRemoveIndex(scenario.build(), 1, contents[1], Result.MatchingValue));
			printTest(scenarioName + "_testRemoveAtIndex2", testRemoveIndex(scenario.build(), 2, null, Result.IndexOutOfBounds));
