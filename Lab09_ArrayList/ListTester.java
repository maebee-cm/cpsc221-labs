...
public class ListTester {
	...
	private void runTests() {
		...
		testEmptyList(newList, "newList"); // Scenario: 01
		...
		// Scenario: 28
		testSingleElementList(AB_remove_B, "AB_remove_B", LIST_AB, STRING_AB);
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents,
		...
		try {
			...
			printTest(scenarioName + "_testAddAfterX",
					testAddAfter(scenario.build(), ELEMENT_C, ELEMENT_D, Result.NoSuchElement));
			...
			printTest(scenarioName + "_testRemoveC",
					testRemoveElement(scenario.build(), ELEMENT_C, Result.NoSuchElement));
			printTest(scenarioName + "_testRemoveAtIndexNeg1",
					testRemoveElement(scenario.build(), null, Result.NoSuchElement));
			...
			printTest(scenarioName + "_testContainsC", testContains(scenario.build(), ELEMENT_C, Result.False));
			printTest(scenarioName + "_testIsEmpty", testIsEmpty(scenario.build(), Result.False));
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents,
		...
		try {
			...
			printTest(scenarioName + "_testAddAfterX",
					testAddAfter(scenario.build(), ELEMENT_A, ELEMENT_D, Result.NoException));
			printTest(scenarioName + "_testAddAfterX",
					testAddAfter(scenario.build(), ELEMENT_B, ELEMENT_D, Result.NoException));
			printTest(scenarioName + "_testAddAfterX",
					testAddAfter(scenario.build(), ELEMENT_C, ELEMENT_D, Result.NoException));
			printTest(scenarioName + "_testAddAfterX",
					testAddAfter(scenario.build(), ELEMENT_D, ELEMENT_X, Result.NoSuchElement));
			...
			printTest(scenarioName + "_testRemoveD",
					testRemoveElement(scenario.build(), ELEMENT_D, Result.NoSuchElement));
			printTest(scenarioName + "_testRemoveAtIndexNeg1",
					testRemoveIndex(scenario.build(), -1, null, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testRemoveAtIndex0",
					testRemoveIndex(scenario.build(), 0, contents[0], Result.MatchingValue));
			...
			printTest(scenarioName + "_testContainsD", testContains(scenario.build(), ELEMENT_D, Result.False));
			printTest(scenarioName + "_testIsEmpty", testIsEmpty(scenario.build(), Result.False));
